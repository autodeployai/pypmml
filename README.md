...
See the [AI-Serving](https://github.com/autodeployai/ai-serving) project. _AI-Serving_ is serving AI models in open standard formats PMML and ONNX with both HTTP and gRPC endpoints.
